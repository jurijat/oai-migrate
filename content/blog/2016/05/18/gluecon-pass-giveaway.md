...
2.  Update those references to reflect the new name `OpenAPI` (See this example [here](https://github.com/anil614sagar/apigee2openapi/pull/7))
...
_\*NOTE: This only applies to the specification that refers to Swagger Specification. For a history on the name change click [here](http://swagger.io/)._
