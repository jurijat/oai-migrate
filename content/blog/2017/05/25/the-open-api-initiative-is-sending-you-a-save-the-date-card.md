...
On March 1st, the Open API Initiative (OAI) [announced](/blog/2017/03/01/openapi-spec-3-implementers-draft-released) the publication of the first OpenAPI Specification v3.0.0 Implementer’s Draft. This release was tagged [3.0.0-rc0](https://github.com/OAI/OpenAPI-Specification/releases/tag/3.0.0-rc0), and we had a subsequent release tagged [3.0.0-rc1](https://github.com/OAI/OpenAPI-Specification/releases/tag/3.0.0-rc1) near the end of April.
...
-   **Latest v3.0.0 spec draft:**
    [https://github.com/OAI/OpenAPI-Specification/blob/OpenAPI.next/versions/3.0.md](https://github.com/OAI/OpenAPI-Specification/blob/OpenAPI.next/versions/3.0.md)
-   Open pull requests:
    [https://github.com/OAI/OpenAPI-Specification/pulls](https://github.com/OAI/OpenAPI-Specification/pulls)
-   Contributing:
    [https://github.com/OAI/OpenAPI-Specification/blob/OpenAPI.next/CONTRIBUTORS.md](https://github.com/OAI/OpenAPI-Specification/blob/OpenAPI.next/CONTRIBUTORS.md)
-   **Some highlights of the updates in OpenAPI Spec v3.0.0:**
    [https://www.openapis.org/blog/2017/01/24/a-new-year-a-new-specification](/blog/2017/01/24/a-new-year-a-new-specification)
-   Introduction to OpenAPI Spec v3.0.0 series:
    [https://www.openapis.org/specification/v3insights](/specification/v3insights)
