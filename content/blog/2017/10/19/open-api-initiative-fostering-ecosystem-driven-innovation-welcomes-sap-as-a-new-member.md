...
SAP continues its commitment to the open source community, having previously joined transformative Linux Foundation projects such as [Cloud Foundry](https://cloudfoundry.org/), [Hyperledger](https://www.hyperledger.org/) and [Node.js Foundation](https://nodejs.org/en/).
