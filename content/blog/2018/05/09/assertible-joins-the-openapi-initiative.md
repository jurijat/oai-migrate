...
![](/img/uploads/2018/04/assertible-logo-horizontal.webp)Assertible enables businesses of all shapes and sizes to confidently monitor the quality and stability of their APIs, allowing for faster iteration and development cycles without compromising correctness in the applications. Utilizing the [OpenAPI Spec](https://github.com/OAI/OpenAPI-Specification) has proven to be a big advantage for teams by providing a way to communicate the intent, functionality, and purpose of their APIs from documentation, to development, and testing.
...
Assertible is pleased to announce it has added support for [OpenAPI v3](https://github.com/OAI/OpenAPI-Specification/tree/master/versions) and has been working with the OAS and its predecessor the [Swagger Spec](https://assertible.com/blog/testing-an-api-using-swagger) since the company’s inception in 2015. Currently, it’s possible to [create a fully automated test suite](https://assertible.com/docs/guide/web-services#importing-a-swagger/openapi-spec) from a simple, or complex, specification.

We plan on continuing to extend our support to include support for features – like JSON Schema, examples, and more – to pave the way for 100% automated test coverage using OpenAPI. If you have any thoughts or requests for extending OAS support in Assertible, [we’d love to hear them](https://assertible.com/contact).
...
– [Reach out on Twitter](https://twitter.com/AssertibleApp), or
– [Send us an email](https://assertible.com/contact)
