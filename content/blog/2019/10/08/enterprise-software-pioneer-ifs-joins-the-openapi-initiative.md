...
Learn more about how IFS enterprise software solutions can help your business today at [ifs.com](https://www.ifsworld.com/us/).

Follow IFS on Twitter: [@ifs](https://twitter.com/ifs)

Visit the IFS Blog on technology, innovation and creativity: [https://blog.ifs.com/](https://blog.ifs.com/)

# More OpenAPI Resources

-   [Become a Member](/membership/join)
-   [Join the OpenAPI Initiative Mailing List](/get-involved/mailing-lists)
-   [How to Contribute to the OAS](https://github.com/OAI/OpenAPI-Specification/blob/master/GOVERNANCE.md)
-   [Twitter](https://twitter.com/OpenApiSpec) (@OpenAPISepc)
-   [Twitter](https://twitter.com/APISpecs) (@APISpecs)
-   [LinkedIn](https://www.linkedin.com/groups/8556951/)
