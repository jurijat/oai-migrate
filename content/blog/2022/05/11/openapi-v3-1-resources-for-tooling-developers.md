...
OpenAPI v3.1.0 has [a bunch of great changes](/blog/2021/02/18/openapi-specification-3-1-released), solving problems like the [subtle differences between JSON Schema objects and OpenAPI Schema objects](https://apisyouwonthate.com/blog/openapi-json-schema-divergence), and adds support for Webhooks.
...
-   [OpenAPI official release notes](/blog/2021/02/18/openapi-specification-3-1-released)
-   [OpenAPI Blog: Migrating from 3.0 to 3.1](/blog/2021/02/16/migrating-from-openapi-3-0-to-3-1-0)
...
-   [OpenAPI v3.1 Resources for Tooling Developers](https://hackmd.io/Y9WDJt9KRYaPPNBgZpajsQ#OpenAPI-v31-Resources-for-Tooling-Developers)
    -   [Do you need to support everything?](https://hackmd.io/Y9WDJt9KRYaPPNBgZpajsQ#Do-you-need-to-support-everything)
    -   [JSON Schema consolidation](https://hackmd.io/Y9WDJt9KRYaPPNBgZpajsQ#JSON-Schema-consolidation)
    -   [Test Cases](https://hackmd.io/Y9WDJt9KRYaPPNBgZpajsQ#Test-Cases)
    -   [Validation Schema](https://hackmd.io/Y9WDJt9KRYaPPNBgZpajsQ#Validation-Schema)
    -   [Find Other v3.1 Tooling](https://hackmd.io/Y9WDJt9KRYaPPNBgZpajsQ#Find-Other-v31-Tooling)

[Expand all](https://hackmd.io/Y9WDJt9KRYaPPNBgZpajsQ#)[Back to top](https://hackmd.io/Y9WDJt9KRYaPPNBgZpajsQ#)[Go to bottom](https://hackmd.io/Y9WDJt9KRYaPPNBgZpajsQ#)
