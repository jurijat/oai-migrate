...
The OpenAPI Initiative, the consortium of forward-looking industry experts focused on evolving and implementing the OpenAPI Specification (OAS), is announcing that [Karate Labs](https://www.karatelabs.io/) has joined as a new member.
...
OpenAPI Initiative is always welcoming NEW MEMBERS, find more information about becoming an OpenAPI member [here](/membership/join)!

Karate Labs Resources:

-   [Karate Labs Home Page](https://www.karatelabs.io/)
-   [Karate Labs Documentation](https://karatelabs.github.io/karate/)
-   [Karate Labs Github](https://github.com/karatelabs)
-   [Karate Labs Stack Overflow](https://stackoverflow.com/questions/tagged/karate)
-   [Karate Labs LinkedIn](https://www.linkedin.com/company/karatelabs)
