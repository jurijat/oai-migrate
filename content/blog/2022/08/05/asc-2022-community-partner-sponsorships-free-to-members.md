...
Community Partner Sponsorships are available for free for OpenAPI Members or $500 to non-members. (If you want to learn more about becoming a member of the OpenAPI Initiative, [go here](/membership/join).) This partnership is a great opportunity to connect directly with API practitioners including API developers, API Operations teams, API Designers and Enterprise Architects.
...
## [Become a Sponsor!](https://events.linuxfoundation.org/openapi-asc/sponsor/)
