...
With planned patch releases for the 3.0 and 3.1 branches coming up, it’s “clarification season” in the OpenAPI Specification project. These changes address common questions and confusion, to make sure that the specification is as clear as possible. We’ve also made improvements to the tooling for publishing the specifications as HTML from the Markdown sources that we maintain in the repository, in preparation for releasing new versions. You can see all the changes and activity on the [OpenAPI-Specification repository](https://github.com/OAI/OpenAPI-Specification) on GitHub.

Our biggest contributor for clarifications to the OpenAPI Specification and fixing an enormous number of ambiguities and open questions in the specification is [Henry Andrews](https://github.com/handrews). A big thank you to Henry for all his effort in making our “small print” readable by anyone.
...
That’s it for this newsletter. If you have news you want to share with the OpenAPI community please get in touch by email or [join the Outreach channel on Slack](https://communityinviter.com/apps/open-api/openapi). We also welcome suggestions on how we can improve this newsletter or bring you information that can help make the most of how you use specifications published by the OpenAPI Initiative.
