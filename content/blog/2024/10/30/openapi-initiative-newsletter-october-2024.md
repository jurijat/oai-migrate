...
Our 3.0.4 and 3.1.1 patch releases of the OpenAPI Specification are also [complete](/blog/2024/10/25/announcing-openapi-specification-patch-releases)!. 3.0.4 and 3.1.1 serve to provide clarifications for implementers across both 3.0 and 3.1 versions of the standard, to ensure consistency in readiness for OpenAPI 4.0 (“Moonwalk”).

The development of Moonwalk continues and has included revisiting the OpenAPI landscape and what each part of the ecosystem looks like. You can read more in our Moonwalk [Discussions](https://github.com/OAI/sig-moonwalk/discussions) board. Please also take time to read Henry Andrew’s [blog](https://modern-json-schema.com/analyzing-the-openapi-tooling-ecosystem) that describes the analysis of the OpenAPI tooling ecosystem, and presents both the architecture and relationships implicit in the ecosystem.
...
In London, Erik was joined by [Frank Kilcommins](https://www.linkedin.com/in/frank-kilcommins/) who went deep on Arazzo, [Sohaib Tariq](https://www.linkedin.com/in/sohaibtariqsprofile/) who talked about the APIMatic API Copilot, [Lorna Mitchell](https://www.linkedin.com/in/lornajane/) who discussed API description pipelines, and [Dr Gobe Hobona](https://www.linkedin.com/in/gobehobona/), who explained how OpenAPI is leveraged by the Open Geospatial Consortium to support the geospatial ecosystem.

Erik was joined in Melbourne by [Adeel Ali](https://www.linkedin.com/in/adeel-apimatic/) who talked about how OpenAPI helps with code and portal generation, and [Patrick Chiu](https://www.linkedin.com/in/patrick-c-74672b15/) who discussed the role of OpenAPI in federated API management. The wealth and breadth of topics show how the API ecosystem uses and embraces OpenAPI. The tracks are also extremely well attended, which is a testament to their value for apidays conference attendees.
