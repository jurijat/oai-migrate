...
The OAI Track traveled to New York, where [Erik Wilde](https://www.linkedin.com/in/erikwilde/) led a variety of sessions ranging from bringing together OpenAPI and AsyncAPI through common JSON Schema reuse, great API design approaches, and the impact of AI on API design and utilization. Naturally, the theme of AI runs through all the conference agendas, and [Frank Kilcommins](https://www.linkedin.com/in/frank-kilcommins/) covered elements of this in his talks in both New York and Apidays Helsinki in June, where “example mapping” by humans helps drive the activities and an AI in creating OpenAPI and Arazzo.

At both New York and Helsinki, the OAI Track has reflected on our efforts as a community in redefining member value, with a special focus at New York where we held a breakfast session to discuss ideas around how OAI member benefits might be evolved in the future. The New York saw Erik Wilde, Frank Kilcommins, [Stu Waldron](https://www.linkedin.com/in/stu-waldron-b550a61/), and BGB Chair [Budha Bhattacharya](https://www.linkedin.com/in/budha-b/) describe how members contribute to the development of OAI specifications. Members fund how OAI operates and are of critical importance to the health of our project. We are revisiting member value in 2025, which is discussed in more detail below.
...
For Arazzo we’ve seen a number of tools that help with visualizing Arazzo design, with an example coming from [Symplr](https://arazzo-editor.symplr.io/), which helps you to map out Arazzo flows in a graphical way. We mentioned Symplr in our last newsletter, but they have since released a [blog post](https://symplr.io/blog/visual-api-workflow-builder-for-arazzo-by-symplr-io/) that discusses more about the tool, their approach, and the fundamentals of Arazzo.
...
If you have feedback or are interested in exploring any of the content in this newsletter further, please get in touch on the [Outreach channel](https://open-api.slack.com/archives/C0KM0KXU6) on Slack or email us at outreach@openapis.org.
