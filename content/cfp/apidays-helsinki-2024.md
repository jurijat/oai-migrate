...
# **Call for Proposals: OAI Track at [API Days Helsinki](https://www.apidays.global/helsinki_and_north/)**
...
The OpenAPI Initiative (OAI) is soliciting submissions for a specific “OAI Track” at API Days Helsinki & North 2024. The goal of this track is to provide a forum where practitioners can share and exchange information about their use of OpenAPI, about tools that they are using or building, or about extensions or augmentations of the specification that may be of interest to the API community.
...
Please submit your proposals [through the submission page of API Days Helsinki 2024](https://apidays.typeform.com/to/ILJeAaV8#event_name=xxxxx).

### Registration and Participation

The OAI Track is an integral part of API Days Helsinki & North 2024. Speakers have to register [through the registration page of API Days Helsinki 2024](https://ticket.apidays.global/event/apidays-helsinki-north-2024/2639c519-817e-401b-993a-54439e8d7214/cart)
