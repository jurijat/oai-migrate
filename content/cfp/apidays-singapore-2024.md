...
The OpenAPI Initiative (OAI) is soliciting submissions for a specific “OAI Track” at API Days Singapore 2024. The goal of this track is to provide a forum where practitioners can share and exchange information about their use of OpenAPI, about tools that they are using or building, or about extensions or augmentations of the specification that may be of interest to the API community.
...
Please submit your proposals [through the submission page of API Days Singapore 2024](https://apidays.typeform.com/to/ILJeAaV8?typeform-source=www.apidays.global#event_name=xxxxxhttps://apidays.typeform.com/to/ILJeAaV8?typeform-source=www.apidays.global#event_name=xxxxx).

### Registration and Participation

The OAI Track is an integral part of API Days Singapore 2024. Speakers have to register [through the registration page of API Days Singapore 2024](https://ticket.apidays.global/event/apidays-singapore-2023/e4cd0614-05fb-48d0-b266-a1f0f37bf10d/cart)
